...
const Footer = () => {
  return (
    <div className=' mt-[20px] text-[#d9d9d9] bg-[#323232] flex flex-col items-center gap-[20px] py-[20px] px-[8vw] pt-[90px] '>
      ...
      <p className="mb-10">Copyright 2024 @ Tomato.com - All Right Reserved.</p>
    </div>
  )
}
